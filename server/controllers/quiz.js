...
const publish_quiz = async(req, res) => {
    ...
    try {
        ...
        console.log("published", result, quizId);
        ...
        res.json({ error: "An error occurred while publishing the quiz" });
    }
}
...
module.exports = {create_quiz , get_quizzes, get_quiz, update_quiz, delete_quiz, update_ques , publish_quiz};